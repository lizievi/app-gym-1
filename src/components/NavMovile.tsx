...
export const NavMovile: FC<Props> = ({ navMobile }) => {
  return (
    <nav
      className={`${
    ...
    >
      ...
      <div className="-mt-44 flex justify-center gap-x-8">
        ...
        <button className="btn btn-lg text-white">Iniciar sesión</button>
        <button className="btn btn-lg btn-primary">Registrarse</button>
      </div>
    </nav>
  );
};
